      ...
      <div className="grid grid-cols-[repeat(auto-fill,minmax(90px,1fr))] p-2 content-start">
        {items.map((item) => {
          ...
          return (
            <div
              key={item.path}
              className={`flex flex-col items-center gap-1 p-2 rounded hover:bg-[#cce8ff] hover:border-[#99d1ff] border border-transparent cursor-pointer text-center group transition-opacity ${
                isCut ? "opacity-40" : ""
              }`}
